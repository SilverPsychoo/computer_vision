...
def build_model(input_dim):
  ...
  x = tf.keras.layers.Dense(64, activation="relu", kernel_regularizer=tf.keras.regularizers.l2(1e-1))(inputs)
  x = tf.keras.layers.Dropout(0.25)(x)
  x = tf.keras.layers.Dense(32, activation="relu")(x)
  x = tf.keras.layers.Dropout(0.20)(x)
  outputs = tf.keras.layers.Dense(1, activation="sigmoid", kernel_regularizer=tf.keras.regularizers.l2(1e-4))(x)
